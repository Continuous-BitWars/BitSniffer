...
import {SimpleCamera} from "../../models/camera/camera";
import {baseCameraLocation, baseCameraTarget, maxCameras, minCameras} from "../../config";
...
export class CameraService {
  ...
  public resetCamera(id: number): void {
    ...
    this.updateCamera(id, baseCameraLocation, baseCameraTarget);
  ...
  public updateCamera(id: number, position: Vector3, target: Vector3): void {
